...
const About = () => {
  return (
    <div className="flex gap-6 flex-col p-6 bg-white shadow-lg rounded-xl mt-10">
      <h2 className="text-3xl font-bold text-green-700 ">EatRight</h2>
      ...
      <p className="text-gray-700 font-semibold">With EatRight, you can:</p>
