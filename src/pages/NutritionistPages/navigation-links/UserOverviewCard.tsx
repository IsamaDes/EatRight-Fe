...
interface NutritionistOverviewCardProps {
  user: User | null;
}

const NutritionistOverviewCard = ({ user }: NutritionistOverviewCardProps) => {

  const handleUpdateProfile = () => {
    // Navigate to nutritionist edit profile
    window.location.href = '/nutritionist/edit-profile';
  };

  const handleDashboard = () => {
    window.location.href = '/nutritonist/dashboard';
  };

  const handleSettings = () => {
    // Navigate to settings
    window.location.href = '/nutritonist/settings';
  };
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg w-[320px] border border-gray-200 overflow-hidden">
      <div className="bg-gradient-to-r from-blue-500 to-blue-800 p-6 text-white">
        <div className="flex flex-col items-center">
          ...
          <h3 className="text-xl font-bold">{user?.name || 'Nutritionist'}</h3>
      ...
      {/* Info Section */}
      <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-200">
      ...
      <div className="px-4 py-3 border-t border-gray-100 bg-amber-50">
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-amber-800 leading-relaxed">
            <span className="font-semibold">Nutritionist Access:</span> You have full control over client mealplan management.
          </p>
        </div>
      </div>
      ...
      <div className="p-4 space-y-2 border-t border-gray-100">
        <button 
          ...
          className="w-full py-2.5 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center justify-center gap-2 shadow-md"
        >
...
export default NutritionistOverviewCard;